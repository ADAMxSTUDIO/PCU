                ...
                @if (session('status'))
					<li class="lfr-nav-item nav-item" id="layout_portlet_com_liferay_site_navigation_menu_web_portlet_SiteNavigationMenuPortlet_17" role="presentation" data-submenu-id="rnp_layout_portlet_com_liferay_site_navigation_menu_web_portlet_SiteNavigationMenuPortlet_17_submenu">
						<a aria-labelledby="layout_portlet_com_liferay_site_navigation_menu_web_portlet_SiteNavigationMenuPortlet}_17" class="nav-link text-truncate" href="{{ URL::to('/dashboard') }}" role="menuitem" tabindex="-1" id="yui_patched_v3_18_1_1_1675602507357_190">
							<span class="text-truncate" data-submenu-id="rnp_layout_portlet_com_liferay_site_navigation_menu_web_portlet_SiteNavigationMenuPortlet_17_submenu" style="border: 2px solid #008344;border-radius:5px;padding:5px 5px;">
								Votre Espace  
							</span>
						</a>
					</li>
        ...
        <div class="card-body" style="position:relative;width:50%;left:25%;">
                    <form method="GET" action="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="idcs" type="text" class="form-control @error('idcs') is-invalid @enderror" name="idcs" value="{{ old('idcs') }}" required autofocus>
                        ...
                        <div class="row mb-3">
                          <label for="" style="color:#007E41;" class="col-md-4 col-form-label text-md-end">{{ __('Confirmer mot de passe') }}</label>

                          <div class="col-md-6">
                              <input id="" type="password" class="form-control @error('password') is-invalid @enderror" name="password_confirmation" required>
                          </div>
                      </div>

                        <div class="row mb-3">
                            <label for="last" style="color:#007E41;" class="col-md-4 col-form-label text-md-end">{{ __('Prénom') }}</label>

                            <div class="col-md-6">
                                <input id="last" type="text" class="form-control @error('last') is-invalid @enderror" name="last" value="{{ old('last') }}" required >
                        ...
                        <div class="row mb-3">
                            <label for="first" style="color:#007E41;" class="col-md-4 col-form-label text-md-end">{{ __('Nom') }}</label>

                            <div class="col-md-6">
                                <input id="first" type="text" class="form-control @error('first') is-invalid @enderror" name="first" value="{{ old('first') }}" required >
                        ...
                        <div class="row mb-3">
                            <label for="tel" style="color:#007E41;" class="col-md-4 col-form-label text-md-end">{{ __('Téléphone') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <select name="role" id="role" class="form-select" aria-label="select example">
                                <option value="" selected disabled>Choisissez votre genre autant qu'un utilisateur</option>
                                @forelse ($roles as $role)
                                    <option value="$role" style="text-transform: capitalize">{{ $role->label }}</option>
                                @empty
