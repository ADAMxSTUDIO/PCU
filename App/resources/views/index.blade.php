                    ...
                    <div class="largeContainerBanner">
                        <div class="slidertop">
                            <div class="d-flex flex-wrap align-items-center slidewrap w-100">
                                ...
                                <div style="position:absolute;left:75%;transform:scale(3.5);filter: invert(15%) sepia(94%) saturate(3523%) hue-rotate(337deg) brightness(96%) contrast(99%);">
                                    <img src="/uc_logo.png" alt="urgent_case">    
                                </div>
                            </div>
                        </div>
                    </div>
